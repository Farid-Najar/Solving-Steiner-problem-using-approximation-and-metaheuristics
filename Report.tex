    ...
    %    	\caption{Simulation sur b2 de l'algorithme recuit avec deux lambda différents}
     %   	\label{Figure3}
      %  \end{figure}
        ...
        On peut ainsi conclure, en observant sur la \hyperref[Figure8]{(Figure 8)} que l'algorithme de recuit multiple est probablement le meilleur, étant donné que l'on a généralement des très gros jeux de données, et qu'il converge de façon assez précise même sur d'autres graphes.
